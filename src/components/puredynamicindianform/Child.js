...
class DynamicForm extends Component {
  ...
  renderForm = position => {
    ...
    let formUI = model.map(m => {
      ...
      let texttooltip;
      let textdetail = m.detail;
      if (textdetail !== undefined) {
        texttooltip = <span class="tooltiptext">{textdetail}</span>;
      }
  ...
  render() {
    ...
    return (
      <div className="container">
        ...
        >
          <div className="go-bottom inform">{this.renderForm("left")}</div>
          <div className="go-right inform">{this.renderForm("right")}</div>
        ...
        >
          <div className="go-bottom inform">
            <div>
            ...
            <div>
              ...
              <textarea id="message" name="phone" type="textarea" required />
            </div>
          </div>

          <div className="go-right inform">
            <div>
              <label for="name">Your Name</label>
              <input id="name" name="name" type="text" required />
            </div>
